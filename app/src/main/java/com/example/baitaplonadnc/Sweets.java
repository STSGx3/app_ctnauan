...
public class Sweets extends AppCompatActivity {
    ...
    private void Evenlist() {
        ...
        bt_edit.setOnClickListener(view -> {
            Intent intent = new Intent(Sweets.this, Total_calories.class);
            startActivity(intent);
        });
        bt_search.setOnClickListener(view -> {
            Intent intent = new Intent(Sweets.this, Search.class);
            startActivity(intent);
        });
        bt_user.setOnClickListener(view -> {
            Intent intent = new Intent(Sweets.this, User_ac.class);
            startActivity(intent);
        });
    }
    ...
    public void findID() {
        ...
        dishAdapter = new Dish_Adapter(Sweets.this, mListDish, new Dish_Adapter.IClickListener() {
            @Override
            public void onClick(Dish dish) {
                ...
                Intent intent = new Intent(Sweets.this, About_dish.class);
    ...
    private void getlistDishFromRealtimedatabase(){
        ...
        Query query = databaseReference.orderByChild("classify").equalTo("Sweets");
