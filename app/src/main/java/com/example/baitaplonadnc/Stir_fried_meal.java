...
public class Stir_fried_meal extends AppCompatActivity {
    ImageButton bt_home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stir_fried_meal);
        ...
        findID();
        Evenlist();
        linearLayoutManager = new LinearLayoutManager(Stir_fried_meal.this);
    ...
    private void Evenlist() {
        ...
        bt_home.setOnClickListener(view -> {
            Intent intent = new Intent(Stir_fried_meal.this, Home.class);
            startActivity(intent);
        });
        bt_edit.setOnClickListener(view -> {
            Intent intent = new Intent(Stir_fried_meal.this, Total_calories.class);
            startActivity(intent);
        });
        bt_search.setOnClickListener(view -> {
            Intent intent = new Intent(Stir_fried_meal.this, Search.class);
            startActivity(intent);
        });
        bt_user.setOnClickListener(view -> {
            Intent intent = new Intent(Stir_fried_meal.this, User_ac.class);
            startActivity(intent);
        });
    }
    ...
    public void findID() {
        ...
        dishAdapter = new Dish_Adapter(Stir_fried_meal.this, mListDish, new Dish_Adapter.IClickListener() {
            @Override
            public void onClick(Dish dish) {
                ...
                Intent intent = new Intent(Stir_fried_meal.this, About_dish.class);
    ...
    private void getlistDishFromRealtimedatabase(){
        ...
        Query query = databaseReference.orderByChild("classify").equalTo("Stir_fried_meal");
