...
public class Main_food extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findID();
        Evenlist();
        linearLayoutManager = new LinearLayoutManager(Main_food.this);
    ...
    private void Evenlist() {
        ...
        bt_home.setOnClickListener(view -> {
            Intent intent = new Intent(Main_food.this, Home.class);
            startActivity(intent);
        });
        bt_edit.setOnClickListener(view -> {
            Intent intent = new Intent(Main_food.this, Total_calories.class);
            startActivity(intent);
        });
        bt_search.setOnClickListener(view -> {
            Intent intent = new Intent(Main_food.this, Search.class);
            startActivity(intent);
        });
        bt_user.setOnClickListener(view -> {
            Intent intent = new Intent(Main_food.this, User_ac.class);
            startActivity(intent);
        });
    }
    ...
    public void findID() {
        ...
        dishAdapter = new Dish_Adapter(Main_food.this, mListDish, new Dish_Adapter.IClickListener() {
            @Override
            public void onClick(Dish dish) {
                ...
                Intent intent = new Intent(Main_food.this, About_dish.class);
        ...
        private void getlistDishFromRealtimedatabase(){
            ...
            Query query = databaseReference.orderByChild("classify").equalTo("main_food");
