...
public class Salad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findID();
        Evenlist();
        linearLayoutManager = new LinearLayoutManager(Salad.this);
    ...
    private void Evenlist() {
        ...
        bt_home.setOnClickListener(view -> {
            Intent intent = new Intent(Salad.this, Home.class);
            startActivity(intent);
        });
        bt_edit.setOnClickListener(view -> {
            Intent intent = new Intent(Salad.this, Total_calories.class);
            startActivity(intent);
        });
        bt_search.setOnClickListener(view -> {
            Intent intent = new Intent(Salad.this, Search.class);
            startActivity(intent);
        });
        bt_user.setOnClickListener(view -> {
            Intent intent = new Intent(Salad.this, User_ac.class);
            startActivity(intent);
        });
    }
    ...
    public void findID() {
        ...
        dishAdapter = new Dish_Adapter(Salad.this, mListDish, new Dish_Adapter.IClickListener() {
            @Override
            public void onClick(Dish dish) {
                ...
                Intent intent = new Intent(Salad.this, About_dish.class);
    ...
    private void getlistDishFromRealtimedatabase(){
        ...
        Query query = databaseReference.orderByChild("classify").equalTo("Salat");
