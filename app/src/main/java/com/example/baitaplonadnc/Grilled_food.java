...
public class Grilled_food extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findID();
        Evenlist();
        linearLayoutManager = new LinearLayoutManager(Grilled_food.this);
    ...
    public void findID() {
        ...
        dishAdapter = new Dish_Adapter(Grilled_food.this, mListDish, new Dish_Adapter.IClickListener() {
            @Override
            public void onClick(Dish dish) {
                ...
                Intent intent = new Intent(Grilled_food.this, About_dish.class);
    ...
    private void getlistDishFromRealtimedatabase(){
        ...
        Query query = databaseReference.orderByChild("classify").equalTo("Grilled_food");
