...
public class Soup extends AppCompatActivity {
    ...
    public void findID() {
        ...
        dishAdapter = new Dish_Adapter(Soup.this, mListDish, new Dish_Adapter.IClickListener() {
            @Override
            public void onClick(Dish dish) {
                ...
                Intent intent = new Intent(Soup.this, About_dish.class);
    ...
    private void getlistDishFromRealtimedatabase(){
        ...
        Query query = databaseReference.orderByChild("classify").equalTo("Soup");
